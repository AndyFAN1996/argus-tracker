...
import type { CaptureExceptionContext } from './modules/exception.js'

export type { CaptureExceptionContext } from './modules/exception.js'
...
export default class API {
  ...
  captureException = (error: Error, context: CaptureExceptionContext = {}): void => {
    if (this.app === null || !(error instanceof Error)) {
      return
    }
    this.app.send(getExceptionMessage(error, [], getCaptureExceptionMetadata(context)))
